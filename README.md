...
docker
  run postgres: docker run --name postgres-nest -p 5432:5432 -e POSTGRES_PASSWORD=postgres -d postgres
  // name => ten container, p => port, e => environment

  - check container running : docker container ls
...
Environment variables
  ...
  - add a variable to project (ex: process.env.MY_VARIABLE) : MY_VARIABLE=someValue yarn start:Dev
...
Config schema Validation
 ...
 - yarn add -D @types/hapi__joi
  ...
  => app.module.ts => validationSchema: configValidationSchema,